...
function renderQuestion(){
  if (qNum <= quizData.length){
    ...
    $('#main-box').html('<legend>'+quizData[qNum-1].question+'</legend><img src="'+quizData[qNum-1].img+'" alt='+quizData[qNum-1].alt+'><div class="answer" role="radiogroup"><div class="left"><label class="choiceLeft" tabindex="0"><input type="radio" role="radio" value="'+quizData[qNum-1].answer1+'" name="answer">'+quizData[qNum-1].answer1+'</label><label class="choiceLeft" tabindex="0"><input type="radio" role="radio" value="'+quizData[qNum-1].answer2+'" name="answer">'+quizData[qNum-1].answer2+'</label></div><div class="right"><label class="choiceRight" tabindex="0"><input type="radio" role="radio" value="'+quizData[qNum-1].answer3+'" name="answer">'+quizData[qNum-1].answer3+'</label><label class="choiceRight" tabindex="0"><input type="radio" role="radio" value="'+quizData[qNum-1].answer4+'" name="answer">'+quizData[qNum-1].answer4+'</label></div></div><input type="submit" value="Submit" class="answerButton">');
