...
function renderQuestion(){
  if (qNum <= quizData.length){
    ...
    $('#main-box').html('<label>'+quizData[qNum-1].question+'</label><img src="'+quizData[qNum-1].img+'" alt='+quizData[qNum-1].alt+'><div class="answer" role="radiogroup"><div class="left"><div class="choiceLeft" tabindex="0"><input type="radio" role="radio" value="'+quizData[qNum-1].answer1+'" name="answer">'+quizData[qNum-1].answer1+'</div><div class="choiceLeft" tabindex="0"><input type="radio" role="radio" value="'+quizData[qNum-1].answer2+'" name="answer">'+quizData[qNum-1].answer2+'</div></div><div class="right"><div class="choiceRight" tabindex="0"><input type="radio" role="radio" value="'+quizData[qNum-1].answer3+'" name="answer">'+quizData[qNum-1].answer3+'</div><div class="choiceRight" tabindex="0"><input type="radio" role="radio" value="'+quizData[qNum-1].answer4+'" name="answer">'+quizData[qNum-1].answer4+'</div></div></div><input type="submit" value="Submit" class="answerButton">');
